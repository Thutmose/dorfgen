...
public class Transporter
{
    ...
    public static Entity teleportEntity(Entity entity, Vector3f t2, int dimension, boolean destBlocked)
    {
        ...
        int x = floor(t2.getX()) >> 4;
        int z = floor(t2.getZ()) >> 4;
    ...
    // From RFTools.
    private static Entity transferToDimension(Entity entity, Vector3f t2, int dimension)
    {
    ...
    public static Entity changeDimension(Entity entityIn, Vector3f t2, int dimensionIn)
    {
